...
class Controller{
	...
	*/
	...
	public function addInCart1(int $pid,int $cid,string $color,string $size,string $quantity ,int $price){
		$data=["p_id"=>$pid,"c_id"=>$cid,"color"=>$color,"size"=>$size,"quantity"=>$quantity,"price"=>$price];
