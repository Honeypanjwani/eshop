            ...
            $outputwidth = ($inputheight * $width)/ $height;
             $outputheight = $inputheight;   }										 ?>
									<!--<img src="<?php// echo $img;  ?>" width="<?php //echo 	$outputwidth ?>" height="<?php //echo $outputheight  ?>" alt="">-->
												  <a style='background-image: url("<?php echo $img;?>"); width:<?php echo $outputwidth ?>; height:<?php echo $outputheight  ?>'>
												  </a>
												  
												  <img src="<?php echo $img?>" width="<?php echo $outputwidth ?>" height="<?php echo $outputheight  ?>" alt="Stylexpo">
                  ...
                  <div class="product-detail-main">
					...
					If($cat =="shirt" || $cat == "jeans" || $cat == "kurta" || $cat == "Ethnic Wear"){*/
					  ...
					  <div class="product-size select-arrow input-box select-dropdown mb-20 mt-30">
                        ...
                        <label>Size</label>
                        <fieldset>
							<select class="selectpicker form-control option-drop" id="select-by-size" name="size">

						  	  <?php 
						 //$product_size=$obj_m->fetch_all("size");
						  //id sizes product_id 
						 // $product_size = $obj_m->fetch_where_2("size",,array("name"),array("product_id"=>$id));
						  
						$product_size=$obj_m->fetch_where("size",array("sizes"),array("product_id"=>$id));
	                    //print_r($product_size);
						 ...
						 // $product_size=$obj_m->fetch_where("size",array("*"),array("id"=>$id));
						  ...
						  ?>
                            <option selected="selected" value="#"><?php echo ucfirst($sizes->sizes);?></option>
                      ...
                      <div class="product-color select-arrow input-box select-dropdown mb-20">
                        ...
                        <fieldset>
						  ...
						  ?>
                            <option selected="selected" value="#"><?php echo ucfirst($color->name);?></option>
						<?php }}?>
                          </select>
                        </fieldset>
                      </div>
                      <div class="mb-20">
                        <div class="product-qty">
						  ...
						  <fieldset>
                          <select class="selectpicker form-control" id="qty" name="qty">
                      ...
                      <div class="bottom-detail">
                        <ul>
                          <li class="pro-wishlist-icon"><a  class="wishlist_btn" id="<?php echo $product->id;?>"><span></span>Wishlist</a></li>
                ...
                <ul>
                  <li>
                    <div class="items-Description selected ">
                      <div class="Description"> <strong><?php echo $product->title?></strong><br />
                        <p><?php echo $product->descriptions?></p>
...
$relateds=$obj_m->fetch_where_2("products",array("*"),array("sub_cat_id"=>$id));
//print_r($products);
...
?>	
                ...
                <div class="product-item">
                    ...
                    <div class="product-detail-inner">
                      <div class="detail-inner-left align-center">
                        <ul>
                          ...
                          <li class="pro-wishlist-icon "><a class=" wishlist_btn" id="<?php echo $product->id?>" title="Wishlist"></a></li>
                  ...
                  <div class="product-item-details">
                    ...
                    <div class="price-box"> <span class="price">	<?php echo $product->sale_price?></span> <del class="price old-price">$100.00</del> </div>
                  </div>
                </div>
              </div>
