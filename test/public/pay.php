  ...
  <body onload="submitPayuForm()">
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table>
        ...
        <tr>
          <td>Success URI: </td>
          <td colspan="3"><input name="surl" value="<?php echo (empty($posted['surl'])) ? 'http://localhost:8001/laxman%2019/private%20folder/laxman/ecomarce/new%20poject%20by%20laxman2%20session/public/success.php' : $posted['surl'] ?>" size="64" /></td>
        </tr>
        <tr>
          <td>Failure URI: </td>
          <td colspan="3"><input name="furl" value="<?php echo (empty($posted['furl'])) ? 'http://localhost:8001/laxman%2019/private%20folder/laxman/ecomarce/new%20poject%20by%20laxman2%20session/public/success.php' : $posted['furl'] ?>" size="64" /></td>
        </tr>
