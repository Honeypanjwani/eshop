                      ...
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            ...
                            <li class="pro-wishlist-icon active"><a class="wishlist_btn1"  id="<?php echo $product->id?>" title="Wishlist"></a></li>
                      ...
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            ...
                            <li class="pro-wishlist-icon active"><a id="<?php echo $product->id?>" title="Wishlist"></a></li>
                            <li class="pro-compare-icon"><a href="compare.html" title="Compare"></a></li>
                          </ul>
                        </div>
                      </div>
