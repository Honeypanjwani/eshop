...
<?php 
$bil_info=$obj_m->fetch_where("billing",["biiling_addr_type","name","home","locality","city","pincode"],["customer_id"=>$cid]);
//print_r($bil_info);
//exit;
if(isset($bil_info)){
	foreach($bil_info as $row){
...
$customer_infom=$obj_m->fetch_where("customers",["name","phone_no","email"],["id"=>$cid]);
//print_r($customer_infom);
//exit;
if(isset($customer_infom)){
	foreach($customer_infom as $customer_info){
		$customer_name=$customer_info->name;
		$customer_phoneno=$customer_info->phone_no;
...
<?php include("navbar.php");?>
          ...
          <div id="data-step1" class="account-content" data-temp="tabdata">
            ...
            <div class="mb-30">
			  ...
			  ?>
                <div class="col-12">
                  <div class="heading-part">
                    <h3 class="sub-heading">Hello,<?php echo $customer_name//echo isset($name)?$name:"-";?></h3>
                  </div>
                  <!--<p>Welcome<a class="account-link" id="subscribelink" href="#">Click Here</a></p>-->
                </div>
              </div>
            </div>
            <div class="m-0">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td><ul>
                                <li class="inner-heading"> <b><?php echo isset($name)?$name:"-";?></b> </li>
                                <li>
                                  <p><?php echo isset($home)?$home:"-";?></p>
                                </li>
                                <li>
                                  <p><?php echo isset($locality)?$locality:"-";?></p>
                                </li>
								<li>
	                              <p><?php echo $customer_email;?></p>
                                  <p><?php echo $customer_phoneno;?></p>
                                </li>
                                <li>
                                  <p>India</p>
                                </li>
  ...
  <!-- CONTAINER END --> 
			...
			<?php 
			/*$id="";
			$res = $obj_m->fetch_where("customers",array("*"),array("id"=>$id));
