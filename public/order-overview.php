    ...
    <div class="container">
	  ...
	  <div class="row">
		...
		{?>                      <tbody>
			<tr>
			<td><a href="#">
                            <div class="product-image"><img src="<?php echo $obj_c->get_front_image($item['id'])?>" width="100"></div>
                            </a></td>
		<td><div class="product-title"> <a href="product-page.html"><?= $item['name'];?></a>
                 <div class="product-info-stock-sku m-0">
                    <div>
                <label>Price: </label>
               <div class="price-box"> <span class="info-deta price">Rs:-<?= $item['price'];?></span> </div>
             </div>
            </div>
            <div class="product-info-stock-sku m-0">
              <div>
            ...
            <span class="info-deta"><?= $item['quantity'];?></span> </div>
			   ...
			   <td><div data-id="100" class="total-price price-box"> <span class="price">Rs:-<?= $item['quantity']*$item['price'];?></span> </div></td>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><div class="price-box"> <span class="price">Rs:- <?= $item_total ?></span> </div></td>
                        </tr>
                        <tr>
                          <td>Shipping</td>
                        ...
                        <tr>
                          ...
                          <td><div class="price-box"> <span class="price"><b>Rs:-<?= $item_total ?></b></span> </div></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
